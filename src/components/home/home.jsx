...
import "./home.css";
import profile1 from "../../assets/profile-images/male -3.png";
import profile2 from "../../assets/profile-images/female -1.png";
import profile3 from  "../../assets/profile-images/female -4.png";
import profile4 from "../../assets/profile-images/male -9.png";
                        ...
                        <table id="table-display" className="table">
                            ...
                            <tbody>
                                {this.state.employee.map((employee, index) => (
                                    <tr key={`${index}`}>
                                        <td>
                                            <img src={employee.profilePic === "../../assets/profile-images/male -3.png" ? profile1 :
                                                employee.profilePic === "../../assets/profile-images/female -1.png" ? profile2 :
                                                    employee.profilePic === "../../assets/profile-images/female -4.png" ? profile3 : profile4
